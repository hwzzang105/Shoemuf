				...
				<table border="1" class="board_table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="subject" ><a class="lst" href="qnaShow.jsp" style="color: #333;"><%=bean.getTitle() %></a></td>
							<td class="writer" ><a class="lst" href="#" style="color: #333;" name="content" ><%=bean.getContent() %></a></td>
...
%>
			...
			<button  onclick="if(confirm('로그인 하세요'))location.href='login.jsp';" type="button" >모두삭제</button>
<%
